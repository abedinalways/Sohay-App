...
const Footer = () => {
  return (
    <footer className="footer footer-horizontal footer-center bg-base-300 text-base-content rounded p-4">
      ...
      <aside>
        <p className='font-bold font-[lora] text-purple-900'>
          Copyright © {new Date().getFullYear()} - All right reserved by Sohay
        </p>
      </aside>
    </footer>
  );
